...
epi_reward_00 = np.loadtxt('episode_reward_torque_control_state_history1.txt')
episodes_00 = np.arange(len(epi_reward_00)) + 1

epi_reward_03 = np.loadtxt('episode_reward_torque_control_state_history2.txt')
episodes_03 = np.arange(len(epi_reward_03)) + 1


plt.plot(episodes_00, epi_reward_00, color=lighten_color('b', 0.4),lw = 2.5)
plt.plot(episodes_03, epi_reward_03, color=lighten_color('r', 0.4),lw = 2.5)
...
plt.plot(episodes_03, epi_reward_03, color='r',lw = 1.5)
