...
if __name__ == '__main__':
    ...
    for string_coff in string_coffs:
        modeldir = outdir + '/PPO_model_new1/torque_history_%s.ckpt' % string_coff
        ...
        for d in D:
            ...
            data_dir = '/home/joshua/robot_arm_ws/src/mrm_training_force/training_results/history_state_new/Validation/' + \
