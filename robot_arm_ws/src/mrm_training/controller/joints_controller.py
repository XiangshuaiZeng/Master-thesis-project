...
class joints_controller:
    ...
    def check_all_systems_ready(self):
        ...
        # command_msg = None
        # while command_msg is None and not rospy.is_shutdown():
        #     command_msg = rospy.wait_for_message("/position_controllers/command", Float64MultiArray, timeout=0.1)
        #     self.set_points = command_msg
        #
        # reset_msg = None
        # while reset_msg is None and not rospy.is_shutdown():
        #     reset_msg = rospy.wait_for_message("/reset_controller", Bool, timeout=0.1)
        #     self.reset_controller = reset_msg
        #
        # pause_msg = None
        # while pause_msg is None and not rospy.is_shutdown():
        #     pause_msg = rospy.wait_for_message("/pause_sim", Bool, timeout=0.1)
        #     self.pause_sim = pause_msg
