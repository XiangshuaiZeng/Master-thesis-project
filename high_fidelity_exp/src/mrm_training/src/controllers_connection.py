...
import rospy
from controller_manager_msgs.srv import SwitchController, SwitchControllerRequest,LoadController, UnloadController
...
class ControllersConnection():
    ...
    def __init__(self, namespace):
        ...
        self.controllers_reset = ['position_controllers']
    ...
    def shut_down_controller(self):
        ...
        result_off_ok = self.switch_controllers(controllers_on = [],
                                controllers_off = self.controllers_reset)
        rospy.wait_for_service(self.unload_service_name)
        for controller in self.controllers_reset:
    ...
    def open_controller(self):
        ...
        for controller in self.controllers_reset:
            ...
            # rospy.loginfo('Loading' + controller + 'succeeds!')

        result_on_ok = self.switch_controllers(controllers_on=self.controllers_reset,
                                                controllers_off=[])
    ...
    def reset_mrm_joint_controllers(self):         # modified
        self.reset_controllers(self. controllers_reset)
