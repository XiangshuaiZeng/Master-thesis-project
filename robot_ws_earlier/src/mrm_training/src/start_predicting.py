...
if __name__ == '__main__':
    ...
    for string_coff in string_coffs:
        modeldir = outdir + '/PPO_model_new1/pos_laser_%s.ckpt' % string_coff
        ...
        for d in D:
            ...
            data_dir = '/home/joshua/robot_ws_earlier/src/mrm_training/training_results/pos_control_new/Validation/' + \
            'success_rate_pos_%s_%s.txt' % (string_coff, d)
    ...
    #
    # print "SpawnModel script started"
    ...
    #     env.step(targets_path[-1 - step], action)
    #
    # env.gazebo.unpauseSim()
    # env.pause_sim_pub.publish(Bool(False))
    # mrm_jointpub.move_joints([0.0,0.0,0.0,0.0])
    # time.sleep(5.0)
    # env.pause_sim_pub.publish(Bool(True))
