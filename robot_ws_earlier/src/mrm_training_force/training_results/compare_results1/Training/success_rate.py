...
file_names = ['success_times_torque_laser_00_1.txt','success_times_torque_laser_02_1.txt', 'success_times_torque_laser_06.txt', 'success_times_torque_laser_04_1.txt', 'success_times_torque_laser_08.txt']
...
plt.title('Success rate within 120mm pipes during training')
plt.show()
