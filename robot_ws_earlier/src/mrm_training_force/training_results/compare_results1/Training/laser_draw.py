...
files_name = ['avg_laser_torque_laser_00.txt', 'avg_laser_torque_laser_02.txt', 'avg_laser_torque_laser_06.txt', 'avg_laser_torque_laser_04.txt', 'avg_laser_torque_laser_08.txt']
